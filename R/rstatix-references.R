...
#' Where an internal, undocumented helper is adapted from another package, the
#' source file that carries it names its origin.
#'
...
#' states in its own documentation: \code{\link{anova_test}()} uses
