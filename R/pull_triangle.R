...
#' @param diagonal logical. Default is FALSE. If TRUE, the matrix diagonal is included.
#' @param triangle the type of triangle to pull. Allowed values are one of "upper" and "lower".
#' @return a data frame
#' @examples
...
#' @export
pull_triangle <- function(x, triangle = c("lower", "upper"), diagonal = FALSE){

  triangle <-match.arg(triangle)
  switch(
    triangle,
    lower = pull_lower_triangle(x, diagonal = diagonal),
    upper = pull_upper_triangle(x, diagonal = diagonal)
  )
}
