...
```{r pairwise-comparisons, fig.width=3.5, fig.height=3.5}
# Pairwise t-test
...
```{r comaprison-against-reference-group, fig.width=3.5, fig.height=3.5}
...
```{r comparison-against-base-mean, fig.width=3.5, fig.height=3.5}
# T-test
